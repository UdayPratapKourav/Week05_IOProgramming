package com.jsondata.handsonpracticeproblems.validateanemailfield;
...
public class ValidateJSONEmail {
    public static void main(String[] args) {
        try {
            String schemaJson = "src/main/java/com/jsondata/handsonpracticeproblems/validateanemailfield/schema.json";
            String dataJson = "src/main/java/com/jsondata/handsonpracticeproblems/validateanemailfield/email.json";

package com.csvproblems.advancedproblems.generateReportfromdatabase;
...
public class DatabaseToCSV {
    public static void main(String[] args) {
        ...
        String dbUser = "sa";
        String dbPassword = "";
        String csvFilePath = "src/main/java/com/csvproblems/advancedproblems/generateReportfromdatabase/file.csv";
